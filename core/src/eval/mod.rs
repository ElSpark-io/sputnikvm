...
#[inline]
pub fn eval(_state: &mut Machine<impl VMApi>, opcode: Opcode, _position: usize) -> Control {
	// static TABLE: [fn( state: &mut Box<impl VMApi>, opcode: Opcode, position: usize,) -> Control; 256] = {
