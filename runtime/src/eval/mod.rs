...
pub fn eval<M: VMApi, H: Handler<M>>(
	...
	match opcode {
		...
		Opcode::CREATE => system::create(state, false, handler, f),
		Opcode::CREATE2 => system::create(state, true, handler, f),
		Opcode::CALL => system::call(state, CallScheme::Call, handler, f),
		Opcode::CALLCODE => system::call(state, CallScheme::CallCode, handler, f),
		Opcode::DELEGATECALL => system::call(state, CallScheme::DelegateCall, handler, f),
		Opcode::STATICCALL => system::call(state, CallScheme::StaticCall, handler, f),
